...
import { IdentificacionDeContextosOSituacionesPage } from './identificacion-de-contextos-o-situaciones';
var IdentificacionDeContextosOSituacionesPageModule = /** @class */ (function () {
    ...
    IdentificacionDeContextosOSituacionesPageModule = __decorate([
        NgModule({
            ...
            imports: [
                IonicPageModule.forChild(IdentificacionDeContextosOSituacionesPage),
            ],
        })
    ], IdentificacionDeContextosOSituacionesPageModule);
    return IdentificacionDeContextosOSituacionesPageModule;
}());
export { IdentificacionDeContextosOSituacionesPageModule };
